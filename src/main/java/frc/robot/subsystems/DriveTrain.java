...
public class DriveTrain extends SubsystemBase implements Logged {
  ...
  public DriveTrain(NavX navX) {
    ...
    Transform3d robotToCam = new Transform3d(
        ...
        new Rotation3d(0, Math.toRadians(180 - 13), Math.toRadians(-1.5)));
    ...
    AutoBuilder.configureHolonomic(
        ...
        new HolonomicPathFollowerConfig( // HolonomicPathFollowerConfig, this should likely live in
            ...
            new PIDConstants(0.95, 0.0, 0.0), // Translation PID constants
            new PIDConstants(1.0, 0.0, 0.01), // Rotation PID constants
  ...
  public double findNeededYaw() {
    ...
    return (Math.toDegrees(Math.atan((r_body.getY() - s_body.getY()) / (r_body.getX() - s_body.getX()))));
  }
  ...
  public Matrix<N3, N1> getEstimationStdDevs(Pose2d estimatedPose) {
    ...
    double avgDist = 0;
    for (var tgt : targets) {
      var tagPose = photonPoseEstimator
          .getFieldTags()
