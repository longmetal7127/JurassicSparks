...
/**
 * this is not a subsystem and is not scheduled like other files in this folder
 * it's here for conviencence
 */
public class SwerveModule {
    ...
    public SwerveModule(
        ...
        m_turningEncoder =
            m_turningSparkMax.getAbsoluteEncoder(Type.kDutyCycle);
    ...
    public SwerveModuleState getState() {
        ...
        return new SwerveModuleState(
            ...
            new Rotation2d(
                m_turningEncoder.getPosition() - m_chassisAngularOffset
            )
        );
    }
