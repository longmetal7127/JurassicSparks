...
public class ShooterTrain extends SubsystemBase {
  ...
  private CANSparkMax shooterMotorLeft = new CANSparkMax(
    ShooterConstants.kShooterLeftMotorCanId,
    MotorType.kBrushless
  );
  private CANSparkMax shooterMotorRight = new CANSparkMax(
    ShooterConstants.kShooterRightMotorCanId,
    MotorType.kBrushless
  );
