...
public final class Constants {
    ...
    public static final class DriveConstants {
        ...
        public static final double kDriveBaseRadius = Math
                .sqrt(Math.pow(kTrackWidth / 2, 2) + Math.pow(kWheelBase / 2, 2)); // Distance from farthest wheel to center
    ...
    public static final class ModuleConstants {
        ...
        public static final int kDrivingMotorPinionTeeth = 14; /** TODO: update based on decision */
